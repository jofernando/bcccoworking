...
class ConfigPaginaInicialController extends Controller
{
    ...
    {
        $this->validate($request, ['titulo2'                => 'required|min:3|max:1000',]);
        // Atualiza campos
        $resultado = Configpaginainicial::where('id', '=', 1)
            ->update([
